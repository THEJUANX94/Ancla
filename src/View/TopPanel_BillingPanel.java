...
public class TopPanel_BillingPanel extends JPanel {

	private JButton saleButton;
	private JButton historyButton;

	public TopPanel_BillingPanel(ActionListener listener) {
	...
	private void initComponents(ActionListener listener) {
		...
		saleButton.setActionCommand("Pestaña_Facturacion");
		...
		historyButton.setPreferredSize(new Dimension(170, 20));
		...
		historyButton.setActionCommand("Pestaña_Historial");
